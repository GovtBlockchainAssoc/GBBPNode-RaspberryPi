...
You should also provide your information (and status) on the Node Tracking Spreadsheet at https://docs.google.com/spreadsheets/d/1BWuOzJKzfT9JG4MKBb8oNN365Wee8dWZLN3oVxbytDE/edit?usp=sharing).
...
###### If trying to use network access, often the Pi will connect about 25% of the time allowing you to complete these instructions that way.  If you aren't so lucky, you will either need to use a monitor and keyboard or use your standard non-Windows machine to edit the second partition of the microSD card  (Windows WSL will not be able to read it -- though it is promised in the next version of WSL and may be available now vai the Insiders Preview)
